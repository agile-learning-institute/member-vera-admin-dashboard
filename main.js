    ...
    fetch('sidebar.json')
        ...
        .then(data => {
            data.forEach(item => {
                ...
                // adjust code here to build this html
                // <div class="icon-text">
                //     <svg  class="list-items-icon"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M10,20V14H14V20H19V12H22L12,3L2,12H5V20H10Z" /></svg>
                //     <p>Home</p>
                // </div>                
